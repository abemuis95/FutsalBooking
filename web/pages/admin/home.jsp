<%-- 
    Document   : home
    Created on : Dec 20, 2016, 4:34:29 PM
    Author     : USER
--%>
...
<html>
    ...
    <c:set var="staffBean" value="${sessionScope.staffSession}"/>
                            ...
                            <div class="box box-solid ">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right box-tools">
                                        <button type="button" class="btn btn-default btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="Collapse" >
                                ...
                                <div class="box-body">
                                    <form role="form" action="slideMasuk.html">
                                        ...
                                        <br/>
                                        <button type="submit" class="btn btn-block btn-flat btn-info">Slide Masuk</button>
                                    </form>
                                </div>
                                <!-- /.box-body-->
                            </div>
