<%-- 
    Document   : report
    Created on : Dec 26, 2016, 4:36:37 PM
    Author     : USER
--%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <%@ include file="../main-sidebar-report.jsp" %>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Report<small> Total online booking for this year</small></h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
        ...
        <script>
            var data = {
                ...
                datasets: [
                    {
                        label: "Total of online booking this year",
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
                            'rgba(255, 206, 86, 0.2)',
                        ...
                        borderWidth: 2,
                        data: [ 
                        <%-- Print out value of report count for each month --%>    
                        <c:forEach items="${requestScope.reportMonth}" var="report">                              
                            <c:out value='${report}' />,                               
                        </c:forEach>],
                    }
                ]
