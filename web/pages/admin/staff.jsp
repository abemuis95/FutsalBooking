<%-- 
    Document   : staff.jsp
    Created on : Dec 26, 2016, 3:57:21 PM
    Author     : USER
--%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <%@ include file="../main-sidebar-staff.jsp" %>
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- Borang mohon cuti -->
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form role="form" method="POST" action="InsertStaffServlet">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="fullname" class="form-control input-sm" placeholder="Full Name" required/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" name="name" class="form-control input-sm" placeholder="Full Name" required/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Password</label>
                                                    <input type="text" name="password" class="form-control input-sm" placeholder="Password" required/>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="box">
                                                    <div class="box-header">
                                                        <h2 class="box-title">Staff List :</h2>
                                                    </div>
                                                    <!-- /.box-header -->
                                                    <div class="box-body table-responsive no-padding">
                                                        ...
                                                        <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${requestScope.staff}" var="staff" varStatus="loop">
                                                                    <c:url value="DeleteStaffServlet" var="DeleteURL">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><c:out value="${staff.dateRegistered}" /></td> 
                                                                        <td>
                                                                            <button type="button" data-toggle="modal" data-target="#myModal<c:out value='${staff.id}' />" 
                                                                    ...
                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="myModal<c:out value='${staff.id}' />" role="dialog">
                                                                        <div class="modal-dialog modal-sm">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
